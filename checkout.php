          ...
          <form method="post" action="place_order.php">
            <div class="row g-2">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control rounded-0" id="name" value="David Smith" name="name" />
              </div>
              <div class="col-md-6">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control rounded-0" id="email" value="david.smith@gmail.com"
                  name="email" />
              </div>
              <div class="col-md-6">
                <label for="phone" class="form-label">Phone</label>
                <input type="text" class="form-control rounded-0" id="phone" value="+855 1234 5678" name="phone" />
              </div>
              <div class="col-md-6">
                <label for="city" class="form-label">City</label>
                <input type="text" class="form-control rounded-0" id="city" value="New York" name="city" />
              </div>
              <div class="col-md-12">
                <label for="address" class="form-label">Address</label>
                <input type="text" class="form-control rounded-0" id="address" value="123 Main St, New York, NY 10001"
                  name="address" />
              </div>
